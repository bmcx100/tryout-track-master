...
import { getAllRounds, getCompletedLevels, getSplitStatus, getPlayersForDivision } from "./actions"
...
export default async function AdminContinuationsPage() {
  ...
  const [drafts, { url }, allRounds, completedLevels, splitStatuses, divisionPlayers] = await Promise.all([
    ...
    getPlayersForDivision(associationId, activeDivision),
  ])
