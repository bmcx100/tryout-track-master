...
| 18 | Scraper manual fallback & final team size validation — paste jersey numbers when scraper finds 0, team size warnings | FR-039 | Done |
...
| 30 | Corrections redesign — collapsible cards, parent view, stale data warnings | FR-025–027 | Done |
| 31 | Admin Continuations Redesign — unified manage page, edit/delete rounds, estimated cuts | FR-039 | Done |
...
| 35 | Withdrawn status — status dropdown in detail sheet, faded rows in Previous Teams, excluded from Predictions | FR-021 | Done ([035](035-withdrawn-status.md)) |
...
| 38 | Player birth year — store birth_year on players, infer from division + previous team, admin-editable, SQL backfill | FR-021 | Done ([038](038-player-birth-year.md)) |
| 39 | Multi-team levels — split final team roster into 2 named sub-teams, bulk assign players, update dashboard/favourites/continuations display | FR-016, FR-039 | Done ([039](039-multi-team-levels.md)) |
