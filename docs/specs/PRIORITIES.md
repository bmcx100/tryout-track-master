...
**Specced:** 035 (Withdrawn status), 036 (Multi-session rounds), 037 (Favourite Made Team split)
...
| 37 | Favourite Made Team split — separate Made Team cards per level, reverse level ordering, team names from DB | FR-025 | Specced ([037](037-favourite-made-team-split.md)) |
